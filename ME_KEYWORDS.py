...
ME_PHYSICS_ANTI_KEY_WORDS = ['半導體', '元件', '實驗', '車輛']
ME_PHYSICS_EXP_KEY_WORDS = ['物理']
ME_PHYSICS_EXP_ANTI_KEY_WORDS = ['半導體', '元件', '車輛']
ME_MASCHINENGESTALTUNG_KEY_WORDS = ['繪圖', '電腦輔助', '機械設計', '機構', '機械構', '機械']
ME_MASCHINENGESTALTUNG_ANTI_KEY_WORDS = ['asdgladfj;l']
...
ME_WERKSTOFFKUNDE_ANTI_KEY_WORDS = ['asdgladfj;l']
ME_CONTROL_THEORY_KEY_WORDS = ['控制', '線性系統', '非線性系統']
ME_CONTROL_THEORY_ANTI_KEY_WORDS = ['asdgladfj;l']
ME_FLUIDDYN_KEY_WORDS = ['流體']
ME_FLUIDDYN_ANTI_KEY_WORDS = ['asdgladfj;l']
ME_MECHANIK_KEY_WORDS = ['力學', '動力', '機動']
ME_MECHANIK_ANTI_KEY_WORDS = ['熱力', '流體', '車輛']
