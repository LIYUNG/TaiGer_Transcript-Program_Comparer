...
MGM_MATH_KEY_WORDS = ['線性代數']
MGM_MATH_ANTI_KEY_WORDS = ['asdgladfj;l']
MGM_ECONOMICS_KEY_WORDS = ['經濟學']
MGM_ECONOMICS_ANTI_KEY_WORDS = ['asdgladfj;l']
MGM_BUSINESS_KEY_WORDS = ['企業']
MGM_BUSINESS_ANTI_KEY_WORDS = ['asdgladfj;l', '資料']
MGM_MANAGEMENT_KEY_WORDS = ['管理學', '組織']
MGM_MANAGEMENT_ANTI_KEY_WORDS = ['asdgladfj;l', '資料']
MGM_ACCOUNTING_KEY_WORDS = ['會計']
MGM_ACCOUNTING_ANTI_KEY_WORDS = ['asdgladfj;l']
MGM_STATISTICS_KEY_WORDS = ['統計']
MGM_STATISTICS_ANTI_KEY_WORDS = ['asdgladfj;l']
MGM_FINANCE_KEY_WORDS = ['金融']
MGM_FINANCE_ANTI_KEY_WORDS = ['asdgladfj;l']
...
MGM_EP_RESEARCH_KEY_WORDS = ['觀察研究']
...
# TODO: defining the keywords in proper way (iterative steps: generating, and see result, if mssing, then add keywords/anti_keywords)
MGM_CALCULUS_KEY_WORDS_EN = ['微積分']
MGM_CALCULUS_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_MATH_KEY_WORDS_EN = ['線性代數']
MGM_MATH_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_ECONOMICS_KEY_WORDS_EN = ['經濟學']
MGM_ECONOMICS_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_BUSINESS_KEY_WORDS_EN = ['business']
MGM_BUSINESS_ANTI_KEY_WORDS_EN = ['asdgladfj;l', '資料']
MGM_MANAGEMENT_KEY_WORDS_EN = ['管理學', '組織']
MGM_MANAGEMENT_ANTI_KEY_WORDS_EN = ['asdgladfj;l', '資料']
MGM_ACCOUNTING_KEY_WORDS_EN = ['會計']
MGM_ACCOUNTING_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_STATISTICS_KEY_WORDS_EN = ['統計']
MGM_STATISTICS_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_FINANCE_KEY_WORDS_EN = ['金融']
MGM_FINANCE_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_MARKETING_KEY_WORDS_EN = ['行銷']
MGM_MARKETING_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_OP_RESEARCH_KEY_WORDS_EN = ['作業研究']
MGM_OP_RESEARCH_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_EP_RESEARCH_KEY_WORDS_EN = ['觀察研究']
MGM_EP_RESEARCH_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_PROGRAMMING_KEY_WORDS_EN = ['程式']
MGM_PROGRAMMING_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_DATA_SCIENCE_KEY_WORDS_EN = ['資料']
MGM_DATA_SCIENCE_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
MGM_BACHELOR_THESIS_KEY_WORDS_EN = ['專題', '論文']
