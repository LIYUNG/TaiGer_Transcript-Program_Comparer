...
ME_MASCHINENGESTALTUNG_KEY_WORDS = [
    '繪圖', '電腦輔助', '機械設計', '機械', '工程圖', 'CAD']
ME_MASCHINENGESTALTUNG_ANTI_KEY_WORDS = ['asdgladfj;l', '製造']
ME_MASCHINEN_ELEMENTE_KEY_WORDS = [
    '機構', '機械構']
ME_MASCHINEN_ELEMENTE_ANTI_KEY_WORDS = ['asdgladfj;l']
ME_THERMODYN_KEY_WORDS = ['熱力']
...
ME_WERKSTOFFKUNDE_ANTI_KEY_WORDS = ['asdgladfj;l', '力學', '應用']
ME_CONTROL_THEORY_KEY_WORDS = ['控制', '線性系統', '非線性系統', '動態系統']
ME_CONTROL_THEORY_ANTI_KEY_WORDS = ['asdgladfj;l', '車輛']
ME_FLUIDDYN_KEY_WORDS = ['流體']
...
ME_MECHATRONICS_KEY_WORDS = ['機電', '微處理']
...
ME_MATH_KEY_WORDS_EN = ['math', 'linear algebra', 'differential', '函數',
...
ME_MASCHINENGESTALTUNG_KEY_WORDS_EN = [
    '繪圖', 'computer aid', 'machine design', 'machine', '工程圖', 'cad']
...
ME_COMPUTER_SCIENCE_KEY_WORDS_EN = [
    '計算機', '程式語言', '程式設計', 'object', 'data structure', 'algorithm']
ME_COMPUTER_SCIENCE_ANTI_KEY_WORDS_EN = [
    'asdgladfj;l', '應用', 'Matlab', "labview", "matlab"]
ME_MECHATRONICS_KEY_WORDS_EN = ['機電', '微處理']
...
ME_VEHICLE_KEY_WORDS_EN = ['車輛', '煞車', '內燃機',
