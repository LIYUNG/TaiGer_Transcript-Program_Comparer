...
ME_LINEAR_ALGEBRA_KEY_WORDS = ['代數', '線性代數']
ME_LINEAR_ALGEBRA_ANTI_KEY_WORDS = ['asdgladfj;l']
...
ME_LINEAR_ALGEBRA_KEY_WORDS_EN = ['linear algebra']
ME_LINEAR_ALGEBRA_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
...
ME_DYNAMICS_KEY_WORDS_EN = ['dynamics', 'vibra', '運動學']
