...
def ME_sorter(program_idx, file_path):
    ...
    transcript_sorted_group_map = {
        '微積分': [CME_CALCULUS_KEY_WORDS, CME_CALCULUS_ANTI_KEY_WORDS, ['一', '二']],
        '數學': [CME_MATH_KEY_WORDS, CME_MATH_ANTI_KEY_WORDS],
        '物理': [CME_PHYSICS_KEY_WORDS, CME_PHYSICS_ANTI_KEY_WORDS, ['一', '二']],
        '物理實驗': [CME_PHYSICS_EXP_KEY_WORDS, CME_PHYSICS_EXP_ANTI_KEY_WORDS, ['一', '二']],
        '其他': [USELESS_COURSES_KEY_WORDS, USELESS_COURSES_ANTI_KEY_WORDS], }

    suggestion_courses_sorted_group_map = {
        '微積分': [[], CME_CALCULUS_ANTI_KEY_WORDS],
        '數學': [[], CME_MATH_ANTI_KEY_WORDS],
        '物理': [[], CME_PHYSICS_ANTI_KEY_WORDS],
        '物理實驗': [[], CME_PHYSICS_EXP_ANTI_KEY_WORDS],
    ...
    print("Students' courses analysis and courses suggestion in CME area finished! ")
