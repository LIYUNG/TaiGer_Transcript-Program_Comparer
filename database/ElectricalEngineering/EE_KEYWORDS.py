...
EE_PROGRAMMING_KEY_WORDS = ['計算機', '演算', '資料', '物件', '運算',
...
EE_PHYSICS_ANTI_KEY_WORDS = ['半導體', '元件', '實驗']
EE_PHYSICS_EXP_KEY_WORDS = ['物理']
EE_PHYSICS_EXP_ANTI_KEY_WORDS = ['半導體', '元件']
EE_ELECTRONICS_KEY_WORDS = ['電子']
EE_ELECTRONICS_ANTI_KEY_WORDS = ['實驗','專題', '電力', '固態', '自動化', '倫理', '素養', '進階']
EE_ELECTRONICS_EXP_KEY_WORDS = ['電子實驗','電子']
EE_ELECTRONICS_EXP_ANTI_KEY_WORDS = ['專題', '電力', '固態']
EE_ELECTRO_CIRCUIT_KEY_WORDS = ['電路', '訊號', '數位邏輯', '邏輯設計']
EE_ELECTRO_CIRCUIT_ANTI_KEY_WORDS = ['超大型', '專題', '倫理', '素養', '進階']
EE_SIGNAL_SYSTEM_KEY_WORDS = ['訊號與系統', '信號與系統']
EE_SIGNAL_SYSTEM_ANTI_KEY_WORDS = ['超大型', '專題']
EE_ELECTRO_MAGNET_KEY_WORDS = ['電磁']
EE_ELECTRO_MAGNET_ANTI_KEY_WORDS = ['asdgladfj;l', '專題', '進階']
EE_POWER_ELECTRO_KEY_WORDS = ['電力', '能源', '電動機', '電機', '高壓電', '電傳輸']
EE_POWER_ELECTRO_ANTI_KEY_WORDS = ['asdgladfj;l', '專題', '進階']
EE_COMMUNICATION_KEY_WORDS = ['高頻', '天線', '微波',
...
EE_PROGRAMMING_KEY_WORDS_EN = ['computer', 'algorithm', 'object', 'computing',
                               '資電', 'operating system', 'data structure', 'software', 'compiler', 'programming', 'language', 'Python', 'C++', 'c language']
...
EE_PHYSICS_EXP_KEY_WORDS_EN = ['物理']
...
EE_ELECTRONICS_ANTI_KEY_WORDS_EN = [
    '專題', 'power', 'solid', 'automation', 'ethnic', '素養', 'advanced']
EE_ELECTRONICS_EXP_KEY_WORDS_EN = ['電子實驗', '電子']
EE_ELECTRONICS_EXP_ANTI_KEY_WORDS_EN = ['專題', '電力', '固態']
EE_ELECTRO_CIRCUIT_KEY_WORDS_EN = [
    'circuit', 'signal', '數位邏輯', 'logic', '信號與系統', '訊號與系統']
EE_ELECTRO_CIRCUIT_ANTI_KEY_WORDS_EN = ['超大型', '專題']
EE_SIGNAL_SYSTEM_KEY_WORDS_EN = ['訊號與系統', '信號與系統']
EE_SIGNAL_SYSTEM_ANTI_KEY_WORDS_EN = ['超大型', '專題']
...
EE_COMMUNICATION_KEY_WORDS_EN = ['high frequen', 'antenna', 'microwave',
...
EE_APPLICATION_ORIENTED_KEY_WORDS_EN = ['生醫', 'neuro', '光機電', 'mems', 'iot', 'crypto', 'accoustics',
                                        '影像', 'deep learning', 'optoelectronics', '應用', '綠能', 'cloud', '醫學工程', '再生能源']
