...
EE_ELECTRONICS_ANTI_KEY_WORDS = ['專題', '電力', '固態', '自動化', '倫理', '素養', '進階']
EE_ELECTRO_CIRCUIT_KEY_WORDS = ['電路', '訊號', '數位邏輯', '邏輯設計', '信號與系統', '訊號與系統']
...
EE_PROGRAMMING_ANTI_KEY_WORDS_EN = ['ethnic', 'Python', 'machine learning', 'vision']
