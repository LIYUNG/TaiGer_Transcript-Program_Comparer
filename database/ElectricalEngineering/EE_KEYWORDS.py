...
EE_COMMUNICATION_KEY_WORDS = ['高頻', '天線', '微波', '密碼學', '安全', '傳輸',
...
EE_INTRO_COMPUTER_SCIENCE_ANTI_KEY_WORDS_EN = ['倫理', 'Python', '機器學習']
EE_PROGRAMMING_KEY_WORDS_EN = ['programming',
...
EE_COMMUNICATION_KEY_WORDS_EN = ['high frequen', 'antenna', 'microwave', 'crypto', 'security',
...
EE_APPLICATION_ORIENTED_KEY_WORDS_EN = ['生醫', 'neuro', '光機電', 'mems', 'iot', 'accoustics',
