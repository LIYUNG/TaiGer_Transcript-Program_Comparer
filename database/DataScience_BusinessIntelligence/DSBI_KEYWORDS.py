...
DSBI_MATH_KEY_WORDS = ['線性代數', '離散', '微分', '機率', '數學']
DSBI_MATH_ANTI_KEY_WORDS = ['asdgladfj;l']
...
DSBI_MANAGEMENT_ANTI_KEY_WORDS = ['asdgladfj;l', '資料', '數學', '實習']
...
DSBI_FINANCE_KEY_WORDS = ['金融', '期貨', '投資', '選擇權', '債券']
...
DSBI_BASIC_CS_KEY_WORDS = ['計算機', '資料庫', '資料結構', '演算法', '作業系統', '軟體']
DSBI_BASIC_CS_ANTI_KEY_WORDS = ['asdgladfj;l', '商管']
DSBI_PROGRAMMING_KEY_WORDS = ['程式']
DSBI_PROGRAMMING_ANTI_KEY_WORDS = ['asdgladfj;l']
DSBI_DATA_SCIENCE_KEY_WORDS = ['資料']
DSBI_DATA_SCIENCE_ANTI_KEY_WORDS = ['asdgladfj;l']
...
DSBI_MATH_KEY_WORDS_EN = ['linear algebra',
                          'mathematic', 'equation', 'probability']
...
DSBI_BUSINESS_ANTI_KEY_WORDS_EN = ['asdgladfj;l', '資料']
DSBI_MANAGEMENT_KEY_WORDS_EN = ['management', 'organiz']
DSBI_MANAGEMENT_ANTI_KEY_WORDS_EN = ['asdgladfj;l', '資料']
...
DSBI_DATA_SCIENCE_KEY_WORDS_EN = ['data science', 'information']
DSBI_DATA_SCIENCE_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
