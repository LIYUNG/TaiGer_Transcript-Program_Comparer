...
def PSY_sorter(program_idx, file_path, abbrev, Generated_Version):
    basic_classification_en = {
        ...
        '會計': [PSY_ACCOUNTING_KEY_WORDS_EN, PSY_ACCOUNTING_ANTI_KEY_WORDS_EN],
    ...
    basic_classification_zh = {
        '微積分': [PSY_CALCULUS_KEY_WORDS, PSY_CALCULUS_ANTI_KEY_WORDS],
        '數學': [PSY_MATH_KEY_WORDS, PSY_MATH_ANTI_KEY_WORDS],
        '經濟': [PSY_ECONOMICS_KEY_WORDS, PSY_ECONOMICS_ANTI_KEY_WORDS],
        '計量經濟': [PSY_ECONOMETRICS_KEY_WORDS, PSY_ECONOMETRICS_ANTI_KEY_WORDS],
        '企業': [PSY_BUSINESS_KEY_WORDS, PSY_BUSINESS_ANTI_KEY_WORDS],
        '管理': [PSY_MANAGEMENT_KEY_WORDS, PSY_MANAGEMENT_ANTI_KEY_WORDS],
        '會計': [PSY_ACCOUNTING_KEY_WORDS, PSY_ACCOUNTING_ANTI_KEY_WORDS],
        '統計': [PSY_STATISTICS_KEY_WORDS, PSY_STATISTICS_ANTI_KEY_WORDS],
        '金融': [PSY_FINANCE_KEY_WORDS, PSY_FINANCE_ANTI_KEY_WORDS],
        '行銷': [PSY_MARKETING_KEY_WORDS, PSY_MARKETING_ANTI_KEY_WORDS],
        '作業研究': [PSY_OP_RESEARCH_KEY_WORDS, PSY_OP_RESEARCH_ANTI_KEY_WORDS],
        '觀察研究': [PSY_EP_RESEARCH_KEY_WORDS, PSY_EP_RESEARCH_ANTI_KEY_WORDS],
        '程式': [PSY_PROGRAMMING_KEY_WORDS, PSY_PROGRAMMING_ANTI_KEY_WORDS],
        '資料科學': [PSY_DATA_SCIENCE_KEY_WORDS, PSY_DATA_SCIENCE_ANTI_KEY_WORDS],
        '論文': [PSY_BACHELOR_THESIS_KEY_WORDS, PSY_BACHELOR_THESIS_ANTI_KEY_WORDS],
        '心理學': [PSY_PSYCHOLOGY_KEY_WORDS, PSY_PSYCHOLOGY_ANTI_KEY_WORDS],
        '認知': [PSY_COGNITIVE_SCIENCE_KEY_WORDS, PSY_COGNITIVE_SCIENCE_ANTI_KEY_WORDS],
        '行為': [PSY_BEHAVIOR_KEY_WORDS, PSY_BEHAVIOR_ANTI_KEY_WORDS],
