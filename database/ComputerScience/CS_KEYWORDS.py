...
CS_COMP_NETW_KEY_WORDS = ['電腦網路', '網路', '密碼', '安全', '傳輸', '分散式']
...
CS_MATH_LOGIC_KEY_WORDS = ['數學邏輯', '數理邏輯']
CS_MATH_LOGIC_PROG_ANTI_KEY_WORDS = ['asdgladfj;l']
...
CS_MATH_LIN_ALGE_KEY_WORDS = ['線性代數', '數學', '數值方法', '數值']
CS_MATH_LIN_ALGE_ANTI_KEY_WORDS = ['asdgladfj;l', '管理']
...
CS_ADVANCED_INFO_ANTI_KEY_WORDS = ['asdgladfj;l', '畢業', '社會', '人力']
CS_PHY_CHEM_NS_ENG_KEY_WORDS = ['物理','化學','生物','工程']
CS_PHY_CHEM_NS_ENG_ANTI_KEY_WORDS = ['asdgladfj;l', '畢業', '社會', '人力']
CS_BA_BI_ENG_KEY_WORDS = ['經濟學', '經濟','企業','管理學', '組織', '管理','會計','作業研究','觀察研究']
